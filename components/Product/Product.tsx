		...
		<div className={className} {...props} ref={ref}>
			<Card className={styles.product}>
				...
				<div className={styles.price}>
					...
					{product.oldPrice && <Badge className={styles.oldPrice} color="green">
				...
				<div className={styles.tags}>{product.categories.map(c => <Badge key={c} className={styles.category} color='ghost'>{c}</Badge>)}</div>
