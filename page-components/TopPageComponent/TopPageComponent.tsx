import { Advantages, Htag, Ptag, Product, Sort, Badge } from '../../components';
	...
	return (
		<div className={styles.wrapper}>
			<div className={styles.title}>
				...
				{products && <Badge color='grey' size='m' aria-label={products.length + 'элементов'}>{products.length}</Badge>}
			...
			{firstCategory == TopPageCategory.Courses && page.hh && <HHData {...page.hh} />}
